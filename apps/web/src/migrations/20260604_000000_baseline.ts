...
const baselineStatements = [
  ...
  sql`CREATE TABLE public._places_v (
    ...
    parent_id integer,
    version_slug character varying,
    version_access_type public.enum__places_v_version_access_type DEFAULT 'unknown'::public.enum__places_v_version_access_type,
  ...
  sql`CREATE TABLE public.places (
    ...
    access_type public.enum_places_access_type DEFAULT 'unknown'::public.enum_places_access_type NOT NULL,
